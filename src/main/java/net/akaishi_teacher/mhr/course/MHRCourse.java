...
import net.akaishi_teacher.mhr.course.commands.SetUseCourse;
...
public final class MHRCourse extends MHRFunc implements Deserializer, HorseEvent {
	...
	protected void registerCommands() {
		...
		cmdExecutor.addCommand(new SetUseCourse(mhr, "c_usecourse any", "mhrc.course.usingcourse", "使用するコースを指定します。"));
