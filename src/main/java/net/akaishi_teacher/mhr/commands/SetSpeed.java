...
public class SetSpeed extends MHRAbstractCommand {
	...
	public boolean execute(CommandSender sender, ArrayList<String> args) {
		try {
			...
			pl.getHorseStats().setSpeed(speed);
			sender.sendMessage(pl.getLang().getLocalizedString("Cmd_Out_SetSpeed_Set") + "Speed: " + speed);
	...
	public String getUsage(CommandSender sender) {
		return pl.getLang().getLocalizedString("Cmd_Usage_SetSpeed");
	}
